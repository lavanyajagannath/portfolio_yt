  ...
  return (
    <section id='contact' className='max-w-contentContainer mx-auto py-10 xl:py-32 flex flex-col gap-4 items-center justify-center'>
        ...
        <p className='max-w-[600px] text-center text-textDark'>
            As I&rsquom currently looking for new opportunities, my inbox is always open. Whether you have a question or just want to say hi, I&rsquoll try my best to get back to you!
        </p>
